"""
===========================================================
EXTERNAL CODE USAGE NOTICE

This file contains code adapted from the following GitHub repository:

Repository: VALLR - Visual ASR Language Model for Lip Reading
Author: MarshallT-99
URL: https://github.com/MarshallT-99/VALLR

Specifically, the FaceCropper implementation is reused and adapted
for preprocessing purposes in this Bachelor Semester Project (BSP).

Modifications:
- Integrated into a video frame processing pipeline
- Used for frame-wise face extraction prior to model input generation

This code is NOT originally written by the author of this project.
It is used in accordance with academic guidelines and will be
properly cited in the final report.
