...
#SBATCH --output=/mnt/scratch/users/mshustrov/BSP/logs/full_2000_%j.out
#SBATCH --error=/mnt/scratch/users/mshustrov/BSP/logs/full_2000_%j.err
...
ls -lah /mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2
wc -l /mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2/train.tsv
wc -l /mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2/train.wrd
wc -l /mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2/valid.tsv
wc -l /mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2/valid.wrd
wc -l /mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2/dict.wrd.txt
...
time $FAIRSEQ \
  ...
  task.data=/mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2 \
  task.label_dir=/mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2 \
  ...
  hydra.run.dir=/mnt/scratch/users/mshustrov/BSP/experiments/full_finetune_2000 \
  ...
  checkpoint.save_interval_updates=250 \
  checkpoint.keep_interval_updates=4 \
