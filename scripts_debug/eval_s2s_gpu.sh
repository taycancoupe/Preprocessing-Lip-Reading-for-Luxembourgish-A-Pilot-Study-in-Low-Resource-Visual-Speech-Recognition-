...
#SBATCH --output=/mnt/scratch/users/mshustrov/BSP/logs/eval_s2s_%j.out
#SBATCH --error=/mnt/scratch/users/mshustrov/BSP/logs/eval_s2s_%j.err
...
CKPT=/mnt/scratch/users/mshustrov/BSP/experiments/full_finetune_probe/checkpoints/checkpoint_best.pt
DATA=/mnt/scratch/users/mshustrov/BSP/HPC_project_folder/avhubert_manifests_v2
RESULTS=/mnt/scratch/users/mshustrov/BSP/experiments/full_finetune_probe/eval_test_beam10
