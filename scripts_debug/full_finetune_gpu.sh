...
#SBATCH --output=/mnt/scratch/users/mshustrov/BSP/logs/full_finetune_%j.out
#SBATCH --error=/mnt/scratch/users/mshustrov/BSP/logs/full_finetune_%j.err
...
time $FAIRSEQ \
  ...
  hydra.run.dir=/mnt/scratch/users/mshustrov/BSP/experiments/full_finetune_probe \
